#include "ovpCBoxAlgorithmP300IdentifierStimulatorModified.h"
...
uint64 CBoxAlgorithmP300IdentifierStimulatorModified::getClockFrequency(void)
{
	return 128LL << 32;
}

boolean CBoxAlgorithmP300IdentifierStimulatorModified::initialize(void)
{
	...
	m_ui64FlashCountInRepetition=m_ui64ImagesCount+1;
...
boolean CBoxAlgorithmP300IdentifierStimulatorModified::reset(void)
{	
	m_ui64LastTime=0;
...
boolean CBoxAlgorithmP300IdentifierStimulatorModified::uninitialize(void)
{
...
boolean CBoxAlgorithmP300IdentifierStimulatorModified::processInput(OpenViBE::uint32 ui32Index)
{
...
boolean CBoxAlgorithmP300IdentifierStimulatorModified::processClock(OpenViBE::CMessageClock & rMessageClock)
{
	getBoxAlgorithmContext()->markAlgorithmAsReadyToProcess();
	return true;
}

boolean CBoxAlgorithmP300IdentifierStimulatorModified::process(void)
{
	IBoxIO& l_rDynamicBoxContext=this->getDynamicBoxContext();
...
void CBoxAlgorithmP300IdentifierStimulatorModified::generate_sequence(void)
{
...
void CBoxAlgorithmP300IdentifierStimulatorModified::generate_trial_vars(void)
{
...
int64 CBoxAlgorithmP300IdentifierStimulatorModified::getCurrentTimeInRepetition(uint64 ui64CurrentTimeInTrial)
{
	if(m_ui64RepetitionIndex==0)
	{
		return -1;
