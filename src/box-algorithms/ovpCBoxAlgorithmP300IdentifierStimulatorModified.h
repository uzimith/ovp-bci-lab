#ifndef __OpenViBEPlugins_BoxAlgorithm_P300IdentifierStimulatorModified_H__
#define __OpenViBEPlugins_BoxAlgorithm_P300IdentifierStimulatorModified_H__
...
#define OVP_ClassId_BoxAlgorithm_P300IdentifierStimulatorModified OpenViBE::CIdentifier(0x22F72295, 0x755B2F5E)
#define OVP_ClassId_BoxAlgorithm_P300IdentifierStimulatorModifiedDesc OpenViBE::CIdentifier(0x10F70AA4, 0x026273E5)

namespace OpenViBEPlugins
{
	namespace Stimulation
	{
		class CBoxAlgorithmP300IdentifierStimulatorModified : public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_P300IdentifierStimulatorModified);
		...
		class CBoxAlgorithmP300IdentifierStimulatorModifiedDesc : public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("P300 Identifier Stimulator(bci-lab)"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_P300IdentifierStimulatorModified; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Stimulation::CBoxAlgorithmP300IdentifierStimulatorModified; }
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_BoxAlgorithm_P300IdentifierStimulatorModifiedDesc);
		};
	};
};

#endif // __OpenViBEPlugins_BoxAlgorithm_P300IdentifierStimulatorModified_H__
